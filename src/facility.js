...
function facility() {
 ...
 const handleCreateCampaign = (event) => {
    ...
    const datetimeFrom = event.target.datetimeFrom.value;
    const datetimeTo = event.target.datetimeTo.value;
...
<div className="flex h-screen">
    ...
    <div>
      <div className="relative">
          ...
          <div className="absolute z-10 bg-white shadow border border-gray-300 rounded-lg mt-1 w-[95%] left-1/2 transform -translate-x-1/2 top-[5rem]">
            {campaignInfo ? (
              <div className="p-4">
                ...
                <p><strong>Starts:</strong> {campaignInfo.datetimeFrom}</p>
                <p><strong>Ends:</strong> {campaignInfo.datetimeTo}</p>
        ...
        <div className="w-full bg-[#d8dfe7] p-4">
          ...
          <div className="mb-2">
        <label className="block text-gray-700 font-bold mb-1" for="title">
          Title
        </label>
        <input
      ...
      <div className="mb-2">
        <label className="block text-gray-700 font-bold mb-1" for="description">
          Description
        </label>
        <textarea
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
      ...
      <div className="mb-2">
        <label className="block text-gray-700 font-bold mb-1" for="pictures">
          Image
        </label>
        <input
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
      ...
      <div className="mb-2">
        <label className="block text-gray-700 font-bold mb-1" for="category">
          Category
        </label>
 ...
 <label className="block text-gray-700 font-bold mb-2" for="datetimeFrom">
 ...
 <div className="flex">
   ...
   />
      ...
      <div class="facilitybuttons">
        <button
          class="submitbuttonfacility"
          type="submit"
        >
          Create
        </button>
        <button
          class="resetbuttonfacility"
          type="reset"
        >
          Reset
        </button>
